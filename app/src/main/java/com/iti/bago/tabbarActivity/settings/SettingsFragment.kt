...
lateinit var navController:NavController
    ...
    override fun onCreateView(
        ...
        settingsFragmentViewModel = ViewModelProviders.of(this,
            SettingsFragmentFactory).get(SettingsFragmentViewModel::class.java)
       ...
       binding.viewModel = settingsFragmentViewModel
        ...
        binding.logout.setOnClickListener{
            ...
            val id = sharedPrefUtil.saveObj(UserLoginResponseObj(
                UserData("",
                    "" , "" ,"",
                    "", "", "", "", "", "", ""), ""),activity!!)
