...
fun bindRecyclerView(recyclerView: RecyclerView, data:List<FavouritesObj>?) {
    val adapter = recyclerView.adapter as FavouritesRecyclerAdapter
    ...
    ItemTouchHelper(object : ItemTouchHelper.SimpleCallback(
        ...
        override fun onSwiped(viewHolder: RecyclerView.ViewHolder, direction: Int) {
            ...
            adapter.favouritesViewModel.deletefromList(viewHolder.adapterPosition)
...
fun bindStatus(statusImageView: ImageView, status: LoadingStatus?) {
    when (status) {
        ...
        LoadingStatus.EMPTY -> {
            statusImageView.visibility = View.VISIBLE
            statusImageView.setImageResource(R.mipmap.fv_icon)
        }
    }
}
